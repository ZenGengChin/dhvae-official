...
def rotation_6d_to_axis_angle(rotation_6d: torch.Tensor):
    matrix = rotation_6d_to_matrix(d6 = rotation_6d)
    return matrix_to_axis_angle(matrix=matrix)

def axis_angle_to_rotation_6d(axis_angle: torch.Tensor):
    matrix = axis_angle_to_matrix(axis_angle=axis_angle)
    return matrix_to_rotation_6d(matrix=matrix)