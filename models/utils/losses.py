import torch
from intermask.utils.paramUtils import t2m_kinematic_chain as kinematic_chain
from intermask.utils.quaternion import *
from intermask.utils.utils import *
from utils.interx_utils import *
...
class SMPL_Loss(nn.Module):
    ...
    def forward(self, motion1:torch.Tensor, motion2:torch.Tensor, weight_hands=0.5):
        ...
        return self.l1_criterion(joints1_body, joints2_body) + weight_hands * self.l1_criterion(joints1_hands, joints2_hands)